...
internal static class Utilities
{
    ...
    public static BitmapImage ImageFromBase64(this string imageString)
    {
    ...
    {
        return string.IsNullOrEmpty(value) ? string.Empty : string.Concat(value[0].ToString().ToUpper(), value.AsSpan(1));
    }
}
